                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="" style="padding: 28px;">
                                    <c:set value="${requestScope.category.name}" var="name"/>
                                    <form role="form" action="${pageContext.request.contextPath}/admin/category/edit"  method="post">
                                        <label>
                                            <input hidden="" name="id" value="${requestScope.category.id}"/>
                                        </label>
                                        <div class="form-group">
                                            <label for="name">Category Name:</label>
                                            <input id="name" name="cate_name" value="${name}" class="form-control" placeholder="Enter category name" />
                                        </div>

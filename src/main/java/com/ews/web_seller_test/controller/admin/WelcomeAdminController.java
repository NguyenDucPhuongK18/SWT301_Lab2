...
@WebServlet(name = "WelcomeAdminController", urlPatterns = {"/admin"})
public class WelcomeAdminController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("total_pro", productList.size());
        req.setAttribute("total_cat", categoryList.size());
        req.setAttribute("total_orderDetails", orderDetailsList.size());

        req.getRequestDispatcher("/views/admin/view/index.jsp").forward(req, resp);
    }
